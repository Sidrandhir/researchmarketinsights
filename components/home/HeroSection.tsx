...
export default function HeroCarousel() {
  ...
  const slides: Slide[] = useMemo(() => [
    ...
    fallbackImage: "/assets/hero1.webp",
      alt: "",
      title: "",
      subtitle: "",
      description: ""
    ...
    fallbackImage: "/assets/hero2.webp",
      alt: "",
      title: "",
      subtitle: "",
      description: ""
    ...
    fallbackImage: "/assets/hero3.webp",
      alt: "",
      title: "",
      subtitle: "",
      description: ""
  ...
  return (
    <section className="relative w-full h-[50vh] md:h-[60vh] lg:h-[70vh] overflow-hidden">
      ...
      {/* Navigation Arrows */}
      <button
        className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white/80 hover:bg-white text-gray-800 p-2 z-20"
        onClick={goToPrev}
      ...
      <button
        className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white/80 hover:bg-white text-gray-800 p-2 z-20"
        onClick={goToNext}
